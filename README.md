...
- LoRA (rank 512) on DiT q,k,v,o,k_img,v_img,ffn.0,ffn.2
...
- alignment loss: cosine + adaptive weight (clamp 1e5)
...
| `--adaptive_max_weight 100000` | Adaptive weight clamp 상한 |
